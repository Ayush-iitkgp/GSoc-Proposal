...
\tightlist
\item
  Express the ODE model in Julia using \texttt{ParametrizedFunctions.jl}
\item
  Convert the ParametrizedFunctions ODE model to Stan model using the
  functionalities provided by ParametrizedFunctions
\item
  Use Stan.jl to generate posterior distribution of parameters and
